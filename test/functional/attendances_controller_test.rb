...
class AttendancesControllerTest < ActionController::TestCase
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post :create, attendance: { time_in: @attendance.time_in, time_out: @attendance.time_out, user_id: @attendance.user_id }
    end
  ...
  test "should update attendance" do
    put :update, id: @attendance, attendance: { time_in: @attendance.time_in, time_out: @attendance.time_out, user_id: @attendance.user_id }
    assert_redirected_to attendance_path(assigns(:attendance))
  end
